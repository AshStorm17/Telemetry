...
def find_start_end_packets_scapy(pcap_file):
    ...
    # print("Switch-wise statistics:")
    # for mac, stats in switch_wise_statistics.items():
    #     print(f"MAC: {mac}")
    #     print(stats)
    #     print("-" * 20)
...
def end2end_cc2dc(pcap_file_path, CC_Name):
    """
    End-to-end telemetry for a switch.
    """
    # Extract switch statistics
...
if __name__ == "__main__":
    ...
    # # Example usage:
    # pcap_file_path = "all_packets.pcap" # Replace with your pcap file path
    # swstats = find_start_end_packets_scapy(pcap_file_path)
    # print(swstats)
